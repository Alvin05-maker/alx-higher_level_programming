...
class MaxInt_test(unittest.TestCase):
    ...
    def test_similar_elements_not_max(self):
        """
    ...
    def test_similar_elements_max(self):
        """
    ...
    def test_big_numbers(self):
        ...
        """
        self.assertEqual(max_integer([10000000, 500000000, 3000000]), 500000000)
    ...
    def test_many_elements(self):
        ...
        """
        self.assertEqual(max_integer([-58, 0, 15, -20, 30, -40, 0, 5, 15,
